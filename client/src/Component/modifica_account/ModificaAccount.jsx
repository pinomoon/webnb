...
class ModificaAccount extends Component{
    constructor(props){
        super(props);
        this.state={
            nome: "",
                    ...
                    <form name="form" id="form" className="container was-validated col-sm-8 mt-3" method="POST"
                        ...
                        <div className="form-group">
                            ...
                            <input id="nome" name="nome" type="text" className="form-control" maxLength="40"
                                   value={this.state.nome} onChange={this.handleChange} required/>
                            ...
                            <input id="cognome" name="cognome" type="text" className="form-control" maxLength="40"
                                   value={this.state.cognome} onChange={this.handleChange} required/>
                            <div className="invalid-feedback">
                                Inserire cognome
                            </div>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input name="data_di_nascita" id="birthdate" type="date" className="form-control"
                                   value={this.state.data_di_nascita} onChange={this.handleChange} required/>
                            <div className="invalid-feedback">
                        ...
                        <div className="form-group">
                            <div className="col-6">
                                ...
                                <input id="indirizzo" name="indirizzo" type="text" className="form-control"
                                       maxLength="40" value={this.state.indirizzo} onChange={this.handleChange}
                                       required/>
                                <div className="invalid-feedback">
                            ...
                            <div className="col-3">
                                ...
                                <input id="citta" name="citta" type="text" className="form-control" maxLength="40"
                                       value={this.state.citta} onChange={this.handleChange} required/>
                                <div className="invalid-feedback">
                                    Inserire Città
                                </div>
                            </div>
                        ...
                        <p className="lead text-uppercase mt-3">Modifica Dati </p>
                        ...
                        <div className="form-group">
                            ...
                            <input name="password" id="pass" type="password" className="form-control"
                                ...
                                //pattern="^(?=.[a-z])(?=.[A-Z])(?=.*[0-9]).{8,}$"
                                   size="32" maxLength="40" value={this.state.password} onChange={this.handleChange}
                                   required/>
                            <div className="invalid-feedback">
